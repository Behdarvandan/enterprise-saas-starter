        ...
        <GlassPanel className="p-6 sm:p-8">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <span className="flex size-10 items-center justify-center rounded-xl bg-primary/15 text-violet-400">
                <Headset aria-hidden className="size-5" />
              </span>
              <h3 className="text-xl font-semibold tracking-tight text-slate-100">{t("ops.title")}</h3>
            </div>
            <Badge tone="success">
              <LiveDot />
              {t("ops.tag")}
          ...
          <p className="mt-4 text-sm text-slate-400">{t("ops.description")}</p>
          ...
          <div dir="ltr" className="mt-6 flex flex-wrap gap-2 font-mono text-xs">
            <code className="rounded-md bg-slate-800/70 px-2 py-1 text-violet-400">rag_search</code>
            <code className="rounded-md bg-slate-800/70 px-2 py-1 text-violet-400">calendar_booking</code>
          </div>
        </GlassPanel>

        <div
          aria-hidden
          className="flex items-center justify-center gap-2 py-1 text-xs font-medium text-slate-400 lg:flex-col lg:px-2"
        >
          <span className="flex items-center gap-1.5">
            <ArrowDown className="size-4 text-violet-400 lg:hidden" />
            <ArrowRight className="hidden size-4 text-violet-400 lg:block rtl:rotate-180" />
            {t("loop.toDev")}
          </span>
          <span className="flex items-center gap-1.5">
        ...
        <GlassPanel className="p-6 sm:p-8">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-semibold tracking-tight text-slate-100">{t("dev.title")}</h3>
            </div>
            <Badge tone="violet">{t("dev.tag")}</Badge>
          </div>
          <p className="mt-4 text-sm text-slate-400">{t("dev.description")}</p>
          ...
          <div className="mt-6 rounded-xl border border-slate-800 bg-slate-950/60 p-4">
            ...
            <p className="mt-2 text-sm text-slate-200">{t("dev.sample.recommendation")}</p>
            <code dir="ltr" className="mt-3 inline-block rounded bg-slate-800/70 px-2 py-1 font-mono text-[11px] text-violet-400">
