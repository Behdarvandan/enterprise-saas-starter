        ...
        return (
          <li
            ...
            className={cn(
              ...
              failed ? "border-red-400/30 bg-red-400/5" : "border-border bg-muted/40",
            )}
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-baseline justify-between gap-3">
                ...
                <p dir="ltr" className="shrink-0 font-mono text-xs text-muted-foreground">
                  {formatBytes(locale, item.size)}
                </p>
              </div>
              <p className={cn("mt-0.5 text-xs", failed ? "text-red-300" : "text-muted-foreground")} role={failed ? "alert" : undefined}>
                {failed
            ...
            {retryable ? (
              <button
                ...
                className="rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/60"
              >
